                      ...
                      <div className="relative">
                        ...
                        {showGlobalDropdown && (
                          <div className="absolute top-full left-0 mt-1 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                            <a href="/map" className="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700">
                              Carte globale
                            </a>
                    ...
                    <div className="lg:hidden border-t border-gray-200 py-4">
                      <div className="space-y-3">
                           ...
                           <div className="space-y-1">
                             <a href="/map" className="block px-3 py-2 text-sm text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded">
                               Carte globale
                             </a>
