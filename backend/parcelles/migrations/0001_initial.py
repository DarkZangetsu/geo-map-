    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nom', models.CharField(max_length=100)),
                ('categorie', models.CharField(choices=[('social', 'Siège social'), ('regional', 'Siège régional'), ('technique', 'Siège technique'), ('provisoire', 'Siège provisoire')], default='bureau', help_text='Catégorie du siège', max_length=20)),
